    ...
    protected function createLogEntry($action, $object, LoggableAdapter $ea)
    {
        ...
        if ($config = $this->getConfiguration($om, $meta->name)) {
            if ($this->username == null) {
                ...
                $logEntry->setUser($this->container->get('security.token_storage')->getToken()->getUser());
                $logEntry->setCueillette($this->container->get('cueillettes.manager')->getMainCueillette());
