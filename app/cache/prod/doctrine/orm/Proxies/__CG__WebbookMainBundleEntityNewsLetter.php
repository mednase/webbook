 ...
 */
class NewsLetter extends \Webbook\MainBundle\Entity\NewsLetter implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Webbook\\MainBundle\\Entity\\NewsLetter' . "\0" . 'id', '' . "\0" . 'Webbook\\MainBundle\\Entity\\NewsLetter' . "\0" . 'subject', '' . "\0" . 'Webbook\\MainBundle\\Entity\\NewsLetter' . "\0" . 'body', '' . "\0" . 'Webbook\\MainBundle\\Entity\\NewsLetter' . "\0" . 'attachments', 'createdAt', 'updatedAt'];
        }
    ...
    public function addAttachment($media)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addAttachment', [$media]);

        return parent::addAttachment($media);
    }
