 ...
 */
class BookEdition extends \Webbook\MainBundle\Entity\BookEdition implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Webbook\\MainBundle\\Entity\\BookEdition' . "\0" . 'id', '' . "\0" . 'Webbook\\MainBundle\\Entity\\BookEdition' . "\0" . 'body', '' . "\0" . 'Webbook\\MainBundle\\Entity\\BookEdition' . "\0" . 'active', '' . "\0" . 'Webbook\\MainBundle\\Entity\\BookEdition' . "\0" . 'title', '' . "\0" . 'Webbook\\MainBundle\\Entity\\BookEdition' . "\0" . 'createdAt', '' . "\0" . 'Webbook\\MainBundle\\Entity\\BookEdition' . "\0" . 'token', '' . "\0" . 'Webbook\\MainBundle\\Entity\\BookEdition' . "\0" . 'book', 'createdBy', 'updatedBy', 'deletedBy'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BookEdition $proxy) {
