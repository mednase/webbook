 ...
 */
class BookReview extends \Webbook\MainBundle\Entity\BookReview implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Webbook\\MainBundle\\Entity\\BookReview' . "\0" . 'id', '' . "\0" . 'Webbook\\MainBundle\\Entity\\BookReview' . "\0" . 'rate', '' . "\0" . 'Webbook\\MainBundle\\Entity\\BookReview' . "\0" . 'datePost', '' . "\0" . 'Webbook\\MainBundle\\Entity\\BookReview' . "\0" . 'user', '' . "\0" . 'Webbook\\MainBundle\\Entity\\BookReview' . "\0" . 'book', '' . "\0" . 'Webbook\\MainBundle\\Entity\\BookReview' . "\0" . 'note'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BookReview $proxy) {
