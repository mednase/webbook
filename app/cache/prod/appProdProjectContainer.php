...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('IvmuxtCht9', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6MGRsrxtYb', 0, 'Bn+9KwvibU8SgVTzNa-N6N', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $e->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('media_file', $c, $a, $b));
        $e->addEventSubscriber(new \Knp\DoctrineBehaviors\ORM\Blameable\BlameableSubscriber($d, true, 'Knp\\DoctrineBehaviors\\Model\\Blameable\\Blameable', new \Knp\DoctrineBehaviors\ORM\Blameable\UserCallable($this), NULL));
        ...
        $e->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('media_file', $c, $a, $b));
        $e->addEventSubscriber(new \Knp\DoctrineBehaviors\ORM\Geocodable\GeocodableSubscriber($d, true, 'Knp\\DoctrineBehaviors\\Model\\Geocodable\\Geocodable', NULL));
        $e->addEventSubscriber($this->get('notification_sync'));
        $e->addEventSubscriber(new \Knp\DoctrineBehaviors\ORM\Translatable\TranslatableSubscriber($d, new \Knp\DoctrineBehaviors\ORM\Translatable\CurrentLocaleCallable($this), new \Knp\DoctrineBehaviors\ORM\Translatable\DefaultLocaleCallable('fr'), 'Knp\\DoctrineBehaviors\\Model\\Translatable\\Translatable', 'Knp\\DoctrineBehaviors\\Model\\Translatable\\Translation', 'LAZY', 'LAZY'));
        $e->addEventSubscriber($this->get('block_historic.listener'));
        $e->addEventSubscriber(new \Knp\DoctrineBehaviors\ORM\SoftDeletable\SoftDeletableSubscriber($d, true, 'Knp\\DoctrineBehaviors\\Model\\SoftDeletable\\SoftDeletable'));
        $e->addEventSubscriber(new \Knp\DoctrineBehaviors\ORM\Loggable\LoggableSubscriber($d, true, new \Knp\DoctrineBehaviors\ORM\Loggable\LoggerCallable($this->get('logger'))));
        $e->addEventSubscriber(new \Knp\DoctrineBehaviors\ORM\Timestampable\TimestampableSubscriber($d, true, 'Knp\\DoctrineBehaviors\\Model\\Timestampable\\Timestampable', 'datetime'));
        $e->addEventSubscriber(new \Knp\DoctrineBehaviors\ORM\Sluggable\SluggableSubscriber($d, true, 'Knp\\DoctrineBehaviors\\Model\\Sluggable\\Sluggable'));
        $e->addEventSubscriber(new \Knp\DoctrineBehaviors\ORM\Tree\TreeSubscriber($d, true, 'Knp\\DoctrineBehaviors\\Model\\Tree\\Node'));
        $e->addEventSubscriber(new \Knp\DoctrineBehaviors\ORM\Sortable\SortableSubscriber($d, true, 'Knp\\DoctrineBehaviors\\Model\\Sortable\\Sortable'));
        $e->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('media_file', $c, $a, $b));
        $e->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.default_listeners.attach_entity_listeners'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3307, 'dbname' => 'webbook', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $e, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f478dad87b339d20375fb9724169991a1ad25a6f1bf8a15abf943f3ba3346f1c');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Gos\Bundle\WebSocketBundle\Pusher\Wamp\WampPusher A Gos\Bundle\WebSocketBundle\Pusher\Wamp\WampPusher instance
     */
    protected function getGosWebSocket_Wamp_PusherService()
    {
        $this->services['gos_web_socket.wamp.pusher'] = $instance = new \Gos\Bundle\WebSocketBundle\Pusher\Wamp\WampPusher();

        $instance->setRouter($this->get('gos_web_socket.router.wamp'));
        $instance->setSerializer($this->get('gos_web_socket.push_message.serializer'));
        $instance->setName('wamp');
        $instance->setConfig(array('host' => 'http://webbook.marzouk-med.loc', 'port' => 8080, 'ssl' => false, 'origin' => NULL));
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('NaplqSfQ8U', NULL, 'Bn+9KwvibU8SgVTzNa-N6N', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'form/form.book_block.html.twig'), 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'name', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension(${($_ = isset($this->services['assetic.asset_factory']) ? $this->services['assetic.asset_factory'] : $this->getAssetic_AssetFactoryService()) && false ?: '_'}, $this->get('templating.name_parser'), false, array(), array(0 => 'GosWebSocketBundle', 1 => 'MainBundle', 2 => 'FrontOfficeBundle', 3 => 'MessagingBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tyFNECMo8L', 0, 'Bn+9KwvibU8SgVTzNa-N6N', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('s6JmFlFUEs', 0, 'Bn+9KwvibU8SgVTzNa-N6N', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1qo7jY6+ec', 0, 'Bn+9KwvibU8SgVTzNa-N6N', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_USER' => array(0 => 'ROLE_USER'), 'ROLE_CLIENT' => array(0 => 'ROLE_CLIENT'), 'ROLE_AUTHOR' => array(0 => 'ROLE_AUTHOR'), 'ROLE_VALIDATOR' => array(0 => 'ROLE_VALIDATOR'), 'ROLE_ADMINISTRATOR' => array(0 => 'ROLE_ADMINISTRATOR')));
    }
