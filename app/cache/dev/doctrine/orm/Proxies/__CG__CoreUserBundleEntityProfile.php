 ...
 */
class Profile extends \Core\UserBundle\Entity\Profile implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Core\\UserBundle\\Entity\\Profile' . "\0" . 'id', '' . "\0" . 'Core\\UserBundle\\Entity\\Profile' . "\0" . 'firstName', '' . "\0" . 'Core\\UserBundle\\Entity\\Profile' . "\0" . 'lastName', '' . "\0" . 'Core\\UserBundle\\Entity\\Profile' . "\0" . 'civility', '' . "\0" . 'Core\\UserBundle\\Entity\\Profile' . "\0" . 'phone', '' . "\0" . 'Core\\UserBundle\\Entity\\Profile' . "\0" . 'address', '' . "\0" . 'Core\\UserBundle\\Entity\\Profile' . "\0" . 'country', '' . "\0" . 'Core\\UserBundle\\Entity\\Profile' . "\0" . 'city', '' . "\0" . 'Core\\UserBundle\\Entity\\Profile' . "\0" . 'zipCode', '' . "\0" . 'Core\\UserBundle\\Entity\\Profile' . "\0" . 'birthday'];
        }
