 ...
 */
class Category extends \Webbook\MainBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Webbook\\MainBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'Webbook\\MainBundle\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'Webbook\\MainBundle\\Entity\\Category' . "\0" . 'token', '' . "\0" . 'Webbook\\MainBundle\\Entity\\Category' . "\0" . 'books', 'deletedAt', 'createdBy', 'updatedBy', 'deletedBy', 'createdAt', 'updatedAt'];
        }
    ...
    public function getUnderBooks()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUnderBooks', []);

        return parent::getUnderBooks();
    }
