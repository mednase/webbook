...
class BookBlock extends \Webbook\MainBundle\Entity\BookBlock implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     * {@inheritDoc}
     */
    public function setParent(\Webbook\MainBundle\Entity\BookBlock $parent)
    {
    ...
    public function HasValidator($strict = false)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'HasValidator', [$strict]);

        return parent::HasValidator($strict);
    }
