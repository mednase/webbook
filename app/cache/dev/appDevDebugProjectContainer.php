...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '_input_array' => 'getInputArrayService',
            'acme_api.event.authentication_success_listener' => 'getAcmeApi_Event_AuthenticationSuccessListenerService',
            ...
            'block_historic.listener' => 'getBlockHistoric_ListenerService',
            ...
            'checkbox_custom_widget' => 'getCheckboxCustomWidgetService',
            ...
            'datetime_normalizer' => 'getDatetimeNormalizerService',
            ...
            'full_width_text_widget' => 'getFullWidthTextWidgetService',
            ...
            'media_namer.file_namer' => 'getMediaNamer_FileNamerService',
            'media_namer.file_namer.media_file' => 'getMediaNamer_FileNamer_MediaFileService',
            'mobelite_file_widget' => 'getMobeliteFileWidgetService',
            'mobelite_radio_widget' => 'getMobeliteRadioWidgetService',
            ...
            'notification_sync' => 'getNotificationSyncService',
            'parameters.lib.twig_extension' => 'getParameters_Lib_TwigExtensionService',
            'price_float_widget' => 'getPriceFloatWidgetService',
            'price_integer_widget' => 'getPriceIntegerWidgetService',
            'price_string_widget' => 'getPriceStringWidgetService',
            'profiler' => 'getProfilerService',
            'profiler_listener' => 'getProfilerListenerService',
            'property_accessor' => 'getPropertyAccessorService',
            'request_stack' => 'getRequestStackService',
            'response_listener' => 'getResponseListenerService',
            'role.route.service' => 'getRole_Route_ServiceService',
            ...
            'select_checkbox_cueillette_widget' => 'getSelectCheckboxCueilletteWidgetService',
            'select_checkbox_cueillettes_widget' => 'getSelectCheckboxCueillettesWidgetService',
            'select_checkbox_entity_widget' => 'getSelectCheckboxEntityWidgetService',
            'select_checkbox_products_widget' => 'getSelectCheckboxProductsWidgetService',
            'select_checkbox_widget' => 'getSelectCheckboxWidgetService',
            'selectize_choice_widget' => 'getSelectizeChoiceWidgetService',
            'selectize_widget' => 'getSelectizeWidgetService',
            ...
            'syn_notification.topic_service' => 'getSynNotification_TopicServiceService',
            ...
            'tooltip_text_widget' => 'getTooltipTextWidgetService',
            ...
            'tree.twig.extension' => 'getTree_Twig_ExtensionService',
            'twig' => 'getTwigService',
            ...
            'weeks_widget' => 'getWeeksWidgetService',
            'years_selector_widget' => 'getYearsSelectorWidgetService',
            'years_widget' => 'getYearsWidgetService',
        );
        $this->privates = array(
    ...
    /**
     * Gets the '_input_array' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\LibBundle\Form\Type\ArrayType A Core\LibBundle\Form\Type\ArrayType instance
     */
    protected function getInputArrayService()
    {
        return $this->services['_input_array'] = new \Core\LibBundle\Form\Type\ArrayType();
    }

    /**
     * Gets the 'acme_api.event.authentication_success_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\UserBundle\Listener\JWTResponseListener A Core\UserBundle\Listener\JWTResponseListener instance
     */
    protected function getAcmeApi_Event_AuthenticationSuccessListenerService()
    {
        return $this->services['acme_api.event.authentication_success_listener'] = new \Core\UserBundle\Listener\JWTResponseListener($this);
    }

    /**
     * Gets the 'acme_api.event.jwt_created_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\UserBundle\Listener\JWTCreatedListener A Core\UserBundle\Listener\JWTCreatedListener instance
     */
    protected function getAcmeApi_Event_JwtCreatedListenerService()
    {
        return $this->services['acme_api.event.jwt_created_listener'] = new \Core\UserBundle\Listener\JWTCreatedListener($this->get('request_stack'));
    }

    /**
     * Gets the 'acme_api.event.jwt_decoded_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\UserBundle\Listener\JWTDecodedListener A Core\UserBundle\Listener\JWTDecodedListener instance
     */
    protected function getAcmeApi_Event_JwtDecodedListenerService()
    {
        return $this->services['acme_api.event.jwt_decoded_listener'] = new \Core\UserBundle\Listener\JWTDecodedListener($this->get('request_stack'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Core\UserBundle\Form\RegistrationFormType A Core\UserBundle\Form\RegistrationFormType instance
     */
    protected function getApp_Form_RegistrationService()
    {
        return $this->services['app.form.registration'] = new \Core\UserBundle\Form\RegistrationFormType();
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'GosWebSocketBundle', ($this->targetDirs[2].'/Resources/GosWebSocketBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'GosWebSocketBundle', ($this->targetDirs[3].'\\vendor\\gos\\web-socket-bundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MainBundle', ($this->targetDirs[2].'/Resources/MainBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MainBundle', ($this->targetDirs[3].'\\src\\Webbook\\MainBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FrontOfficeBundle', ($this->targetDirs[2].'/Resources/FrontOfficeBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FrontOfficeBundle', ($this->targetDirs[3].'\\src\\Webbook\\FrontOfficeBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MessagingBundle', ($this->targetDirs[2].'/Resources/MessagingBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MessagingBundle', ($this->targetDirs[3].'\\src\\Webbook\\MessagingBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    /**
     * Gets the 'block_historic.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Webbook\MainBundle\Listener\blockHistoricListener A Webbook\MainBundle\Listener\blockHistoricListener instance
     */
    protected function getBlockHistoric_ListenerService()
    {
        return $this->services['block_historic.listener'] = new \Webbook\MainBundle\Listener\blockHistoricListener($this);
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('QAgp1yznw9', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zOZX+XjO5q', 0, 'ZnoRaJmMC17ZiXp-PVQxIK', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, ${($_ = isset($this->services['templating.locator']) ? $this->services['templating.locator'] : $this->getTemplating_LocatorService()) && false ?: '_'}), 1 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetManagerCacheWarmer($this), 2 => $this->get('kernel.class_cache.cache_warmer'), 3 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TranslationsCacheWarmer($this->get('translator.default')), 4 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\ValidatorCacheWarmer($this->get('validator.builder'), (__DIR__.'/validation.php'), \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('n992DgENkb', 0, 'ZnoRaJmMC17ZiXp-PVQxIK', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE))), 5 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 6 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\AnnotationsCacheWarmer(${($_ = isset($this->services['annotations.reader']) ? $this->services['annotations.reader'] : $this->getAnnotations_ReaderService()) && false ?: '_'}, (__DIR__.'/annotations.php'), ${($_ = isset($this->services['cache.annotations']) ? $this->services['cache.annotations'] : $this->getCache_AnnotationsService()) && false ?: '_'}), 7 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\SerializerCacheWarmer(array(0 => new \Symfony\Component\Serializer\Mapping\Loader\AnnotationLoader($this->get('annotation_reader'))), (__DIR__.'/serialization.php'), ${($_ = isset($this->services['cache.serializer']) ? $this->services['cache.serializer'] : $this->getCache_SerializerService()) && false ?: '_'}), 8 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c, array()), 9 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheWarmer($this->get('twig'), new \Symfony\Bundle\TwigBundle\TemplateIterator($a, $this->targetDirs[2], array())), 10 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine'))));
    }

    /**
     * Gets the 'checkbox_custom_widget' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\LibBundle\Form\Type\Checkbox A Core\LibBundle\Form\Type\Checkbox instance
     */
    protected function getCheckboxCustomWidgetService()
    {
        return $this->services['checkbox_custom_widget'] = new \Core\LibBundle\Form\Type\Checkbox();
    }
    ...
    /**
     * Gets the 'datetime_normalizer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Webbook\MainBundle\Services\DateTimeNormalizer A Webbook\MainBundle\Services\DateTimeNormalizer instance
     */
    protected function getDatetimeNormalizerService()
    {
        return $this->services['datetime_normalizer'] = new \Webbook\MainBundle\Services\DateTimeNormalizer();
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('lexik_jwt_authentication.on_authentication_success', array(0 => 'acme_api.event.authentication_success_listener', 1 => 'onAuthenticationSuccessResponse'), 0);
        $instance->addListenerService('lexik_jwt_authentication.on_authentication_failure', array(0 => 'acme_api.event.authentication_success_listener', 1 => 'onAuthenticationFailureResponse'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $f = new \Knp\DoctrineBehaviors\Reflection\ClassAnalyzer();

        $g = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this);
        $g->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('media_file', $e, $a, $b));
        $g->addEventSubscriber(new \Knp\DoctrineBehaviors\ORM\Blameable\BlameableSubscriber($f, true, 'Knp\\DoctrineBehaviors\\Model\\Blameable\\Blameable', new \Knp\DoctrineBehaviors\ORM\Blameable\UserCallable($this), NULL));
        ...
        $g->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('media_file', $e, $a, $b));
        $g->addEventSubscriber(new \Knp\DoctrineBehaviors\ORM\Geocodable\GeocodableSubscriber($f, true, 'Knp\\DoctrineBehaviors\\Model\\Geocodable\\Geocodable', NULL));
        $g->addEventSubscriber($this->get('notification_sync'));
        $g->addEventSubscriber(new \Knp\DoctrineBehaviors\ORM\Translatable\TranslatableSubscriber($f, new \Knp\DoctrineBehaviors\ORM\Translatable\CurrentLocaleCallable($this), new \Knp\DoctrineBehaviors\ORM\Translatable\DefaultLocaleCallable('fr'), 'Knp\\DoctrineBehaviors\\Model\\Translatable\\Translatable', 'Knp\\DoctrineBehaviors\\Model\\Translatable\\Translation', 'LAZY', 'LAZY'));
        $g->addEventSubscriber($this->get('block_historic.listener'));
        $g->addEventSubscriber(new \Knp\DoctrineBehaviors\ORM\SoftDeletable\SoftDeletableSubscriber($f, true, 'Knp\\DoctrineBehaviors\\Model\\SoftDeletable\\SoftDeletable'));
        $g->addEventSubscriber(new \Knp\DoctrineBehaviors\ORM\Loggable\LoggableSubscriber($f, true, new \Knp\DoctrineBehaviors\ORM\Loggable\LoggerCallable($this->get('logger'))));
        $g->addEventSubscriber(new \Knp\DoctrineBehaviors\ORM\Timestampable\TimestampableSubscriber($f, true, 'Knp\\DoctrineBehaviors\\Model\\Timestampable\\Timestampable', 'datetime'));
        $g->addEventSubscriber(new \Knp\DoctrineBehaviors\ORM\Sluggable\SluggableSubscriber($f, true, 'Knp\\DoctrineBehaviors\\Model\\Sluggable\\Sluggable'));
        $g->addEventSubscriber(new \Knp\DoctrineBehaviors\ORM\Tree\TreeSubscriber($f, true, 'Knp\\DoctrineBehaviors\\Model\\Tree\\Node'));
        $g->addEventSubscriber(new \Knp\DoctrineBehaviors\ORM\Sortable\SortableSubscriber($f, true, 'Knp\\DoctrineBehaviors\\Model\\Sortable\\Sortable'));
        $g->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('media_file', $e, $a, $b));
        $g->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.default_listeners.attach_entity_listeners'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3307, 'dbname' => 'webbook', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $d, $g, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Core\\LibBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Core\\UserBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Webbook\\MainBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\Webbook\\NotificationBundle\\Entity'), 4 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\Webbook\\MessagingBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Core\\LibBundle\\Entity');
        $c->addDriver($b, 'Core\\UserBundle\\Entity');
        $c->addDriver($b, 'Webbook\\MainBundle\\Entity');
        $c->addDriver($b, 'Webbook\\NotificationBundle\\Entity');
        $c->addDriver($b, 'Vich\\UploaderBundle\\Entity');
        $c->addDriver($b, 'Webbook\\MessagingBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('LibBundle' => 'Core\\LibBundle\\Entity', 'UserBundle' => 'Core\\UserBundle\\Entity', 'MainBundle' => 'Webbook\\MainBundle\\Entity', 'NotificationBundle' => 'Webbook\\NotificationBundle\\Entity', 'VichUploaderBundle' => 'Vich\\UploaderBundle\\Entity', 'MessagingBundle' => 'Webbook\\MessagingBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a0015fef8df65cc41d11c93ecce92b001a01bad74ea134066fe8f83c72c24d95');
    ...
    {
        return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension($this, array('Core\\UserBundle\\Form\\RegistrationFormType' => 'app.form.registration', 'Symfony\\Component\\Form\\Extension\\Core\\Type\\FormType' => 'form.type.form', 'Symfony\\Component\\Form\\Extension\\Core\\Type\\ChoiceType' => 'form.type.choice', 'Symfony\\Bridge\\Doctrine\\Form\\Type\\EntityType' => 'form.type.entity', 'FOS\\UserBundle\\Form\\Type\\UsernameFormType' => 'fos_user.username_form_type', 'FOS\\UserBundle\\Form\\Type\\ProfileFormType' => 'fos_user.profile.form.type', 'FOS\\UserBundle\\Form\\Type\\RegistrationFormType' => 'fos_user.registration.form.type', 'FOS\\UserBundle\\Form\\Type\\ChangePasswordFormType' => 'fos_user.change_password.form.type', 'FOS\\UserBundle\\Form\\Type\\ResettingFormType' => 'fos_user.resetting.form.type', 'Core\\LibBundle\\Form\\Type\\ArrayType' => '_input_array', 'Core\\LibBundle\\Form\\Type\\WeeksType' => 'weeks_widget', 'Core\\LibBundle\\Form\\Type\\YearType' => 'years_widget', 'Core\\LibBundle\\Form\\Type\\SelectizeType' => 'selectize_widget', 'Core\\LibBundle\\Form\\Type\\SelectizeChoiceType' => 'selectize_choice_widget', 'Core\\LibBundle\\Form\\Type\\SelectCheckbox' => 'select_checkbox_widget', 'Core\\LibBundle\\Form\\Type\\YearsSelector' => 'years_selector_widget', 'Core\\LibBundle\\Form\\Type\\SelectCheckboxCueillettes' => 'select_checkbox_cueillettes_widget', 'Core\\LibBundle\\Form\\Type\\SelectCheckboxCueillette' => 'select_checkbox_cueillette_widget', 'Core\\LibBundle\\Form\\Type\\SelectCheckboxEntity' => 'select_checkbox_entity_widget', 'Core\\LibBundle\\Form\\Type\\TooltipText' => 'tooltip_text_widget', 'Core\\LibBundle\\Form\\Type\\PriceInteger' => 'price_integer_widget', 'Core\\LibBundle\\Form\\Type\\PriceFloat' => 'price_float_widget', 'Core\\LibBundle\\Form\\Type\\PriceString' => 'price_string_widget', 'Core\\LibBundle\\Form\\Type\\FullWidthText' => 'full_width_text_widget', 'Core\\LibBundle\\Form\\Type\\Checkbox' => 'checkbox_custom_widget', 'Core\\LibBundle\\Form\\Type\\SelectCheckboxProducts' => 'select_checkbox_products_widget', 'Core\\LibBundle\\Form\\Type\\RadioType' => 'mobelite_radio_widget', 'Core\\LibBundle\\Form\\Type\\MobeliteFile' => 'mobelite_file_widget', 'Vich\\UploaderBundle\\Form\\Type\\VichFileType' => 'vich_uploader.form.type.file', 'Vich\\UploaderBundle\\Form\\Type\\VichImageType' => 'vich_uploader.form.type.image'), array('Symfony\\Component\\Form\\Extension\\Core\\Type\\FormType' => array(0 => 'form.type_extension.form.http_foundation', 1 => 'form.type_extension.form.validator', 2 => 'form.type_extension.upload.validator', 3 => 'form.type_extension.csrf', 4 => 'form.type_extension.form.data_collector'), 'Symfony\\Component\\Form\\Extension\\Core\\Type\\RepeatedType' => array(0 => 'form.type_extension.repeated.validator'), 'Symfony\\Component\\Form\\Extension\\Core\\Type\\SubmitType' => array(0 => 'form.type_extension.submit.validator')), array(0 => 'form.type_guesser.validator', 1 => 'form.type_guesser.doctrine'))), $this->get('form.resolved_type_factory'));
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('test@gamil.com' => 'test@gamil.com'), 'resetting' => array('test@gamil.com' => 'test@gamil.com'))));
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'Core\\UserBundle\\Form\\RegistrationFormType', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager(${($_ = isset($this->services['fos_user.util.password_updater']) ? $this->services['fos_user.util.password_updater'] : $this->getFosUser_Util_PasswordUpdaterService()) && false ?: '_'}, ${($_ = isset($this->services['fos_user.util.canonical_fields_updater']) ? $this->services['fos_user.util.canonical_fields_updater'] : $this->getFosUser_Util_CanonicalFieldsUpdaterService()) && false ?: '_'}, $this->get('doctrine')->getManager(NULL), 'Core\\UserBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'full_width_text_widget' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\LibBundle\Form\Type\FullWidthText A Core\LibBundle\Form\Type\FullWidthText instance
     */
    protected function getFullWidthTextWidgetService()
    {
        return $this->services['full_width_text_widget'] = new \Core\LibBundle\Form\Type\FullWidthText();
    }
    ...
    {
        $this->services['gos_pubsub_router.loader.websocket'] = $instance = new \Gos\Bundle\PubSubRouterBundle\Loader\RouteLoader($this->get('gos_pubsub_router.collection.websocket'), ${($_ = isset($this->services['gos_pubsub_router.php_file.cache']) ? $this->services['gos_pubsub_router.php_file.cache'] : $this->getGosPubsubRouter_PhpFile_CacheService()) && false ?: '_'}, 'websocket');

        $instance->addResource('@MainBundle/Resources/config/routing/socket.yml');
    ...
    {
        $this->services['gos_web_socket.pusher_registry'] = $instance = new \Gos\Bundle\WebSocketBundle\Pusher\PusherRegistry();

        $instance->addPusher($this->get('gos_web_socket.wamp.pusher'), 'wamp');
    ...
    {
        return $this->services['gos_web_socket.server_command'] = new \Gos\Bundle\WebSocketBundle\Command\ServerCommand($this->get('gos_web_socket.entry_point'), 'http://webbook.marzouk-med.loc', 8080, $this->get('monolog.logger.websocket', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getGosWebSocket_Topic_RegistryService()
    {
        ...
        $instance->addTopic($this->get('syn_notification.topic_service'));
    ...
    protected function getGosWebSocket_Wamp_PusherService()
    {
        ...
        $a->setName('wamp');
        $a->setConfig(array('host' => 'http://webbook.marzouk-med.loc', 'port' => 8080, 'ssl' => false, 'origin' => NULL));
    ...
    {
        return $this->services['gos_web_socket.websocket_server.command'] = new \Gos\Bundle\WebSocketBundle\Command\WebsocketServerCommand($this->get('gos_web_socket.entry_point'), 'http://webbook.marzouk-med.loc', 8080, $this->get('monolog.logger.websocket', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['gos_web_socket.ws.client'] = $instance = new \Gos\Component\WebSocketClient\Wamp\Client('http://webbook.marzouk-med.loc', 8080);
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\swiftmailer-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'\\vendor\\doctrine\\doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\framework-extra-bundle/Resources/config/serializer'), 'FOS\\UserBundle' => 'D:/PFE/webbook/app/serializer/FOSUB', 'Core\\LibBundle' => ($this->targetDirs[3].'\\src\\Core\\LibBundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\assetic-bundle/Resources/config/serializer'), 'Core\\UserBundle' => ($this->targetDirs[3].'\\src\\Core\\UserBundle/Resources/config/serializer'), 'Webbook\\MainBundle' => ($this->targetDirs[3].'\\src\\Webbook\\MainBundle/Resources/config/serializer'), 'Webbook\\NotificationBundle' => ($this->targetDirs[3].'\\src\\Webbook\\NotificationBundle/Resources/config/serializer'), 'Gos\\Bundle\\WebSocketBundle' => ($this->targetDirs[3].'\\vendor\\gos\\web-socket-bundle/Resources/config/serializer'), 'Gos\\Bundle\\PubSubRouterBundle' => ($this->targetDirs[3].'\\vendor\\gos\\pubsub-router-bundle/Resources/config/serializer'), 'Knp\\DoctrineBehaviors\\Bundle' => ($this->targetDirs[3].'\\vendor\\knplabs\\doctrine-behaviors\\src\\Bundle/Resources/config/serializer'), 'Vich\\UploaderBundle' => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'\\vendor\\jms\\serializer-bundle\\JMS\\SerializerBundle/Resources/config/serializer'), 'FOS\\JsRoutingBundle' => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\jsrouting-bundle/Resources/config/serializer'), 'Webbook\\FrontOfficeBundle' => ($this->targetDirs[3].'\\src\\Webbook\\FrontOfficeBundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\rest-bundle/Resources/config/serializer'), 'Lexik\\Bundle\\JWTAuthenticationBundle' => ($this->targetDirs[3].'\\vendor\\lexik\\jwt-authentication-bundle/Resources/config/serializer'), 'Nelmio\\CorsBundle' => ($this->targetDirs[3].'\\vendor\\nelmio\\cors-bundle/Resources/config/serializer'), 'Webbook\\MessagingBundle' => ($this->targetDirs[3].'\\src\\Webbook\\MessagingBundle/Resources/config/serializer'), 'Knp\\Bundle\\PaginatorBundle' => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/config/serializer'), 'Knp\\Bundle\\SnappyBundle' => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-snappy-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\distribution-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\generator-bundle/Resources/config/serializer')));
    ...
    {
        return $this->services['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(array('defaultPaginationTemplate' => 'KnpPaginatorBundle/Pagination/custom_pagination.html.twig', 'defaultSortableTemplate' => 'KnpPaginatorBundle:Pagination:sortable_link.html.twig', 'defaultFiltrationTemplate' => 'KnpPaginatorBundle:Pagination:filtration.html.twig', 'defaultPageRange' => 1));
    }
    ...
    {
        return $this->services['knp_snappy.pdf'] = new \Knp\Bundle\SnappyBundle\Snappy\LoggableGenerator(new \Knp\Snappy\Pdf('wkhtmltopdf', array('no-stop-slow-scripts' => NULL, 'enable-javascript' => NULL, 'use-xserver' => NULL, 'page-size' => 'A4', 'dpi' => 300), array()), $this->get('monolog.logger.snappy', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['lexik_jwt_authentication.key_loader'] = new \Lexik\Bundle\JWTAuthenticationBundle\Services\KeyLoader\OpenSSLKeyLoader(($this->targetDirs[2].'/../var/jwt/private.pem'), ($this->targetDirs[2].'/../var/jwt/public.pem'), 'astalavista');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Core\UserBundle\Security\Authentication\Handler\LoginSuccessHandler A Core\UserBundle\Security\Authentication\Handler\LoginSuccessHandler instance
     */
    protected function getLoginSuccessHandlerService()
    {
        return $this->services['login_success_handler'] = new \Core\UserBundle\Security\Authentication\Handler\LoginSuccessHandler($this->get('router'), $this->get('security.authorization_checker'));
    }

    /**
     * Gets the 'media_namer.file_namer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Webbook\MainBundle\Services\MediaFileNamer A Webbook\MainBundle\Services\MediaFileNamer instance
     */
    protected function getMediaNamer_FileNamerService()
    {
        return $this->services['media_namer.file_namer'] = new \Webbook\MainBundle\Services\MediaFileNamer();
    }

    /**
     * Gets the 'media_namer.file_namer.media_file' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Webbook\MainBundle\Services\MediaFileNamer A Webbook\MainBundle\Services\MediaFileNamer instance
     */
    protected function getMediaNamer_FileNamer_MediaFileService()
    {
        return $this->services['media_namer.file_namer.media_file'] = new \Webbook\MainBundle\Services\MediaFileNamer();
    }

    /**
     * Gets the 'mobelite_file_widget' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\LibBundle\Form\Type\MobeliteFile A Core\LibBundle\Form\Type\MobeliteFile instance
     */
    protected function getMobeliteFileWidgetService()
    {
        return $this->services['mobelite_file_widget'] = new \Core\LibBundle\Form\Type\MobeliteFile();
    }

    /**
     * Gets the 'mobelite_radio_widget' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\LibBundle\Form\Type\RadioType A Core\LibBundle\Form\Type\RadioType instance
     */
    protected function getMobeliteRadioWidgetService()
    {
        return $this->services['mobelite_radio_widget'] = new \Core\LibBundle\Form\Type\RadioType($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['monolog.handler.websocket'] = $instance = new \Symfony\Bridge\Monolog\Handler\ConsoleHandler(NULL, true, array(32 => 100, 16 => 400, 64 => 250, 128 => 200, 256 => 100));
    ...
    /**
     * Gets the 'notification_sync' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Webbook\NotificationBundle\Listener\NotificationSync A Webbook\NotificationBundle\Listener\NotificationSync instance
     */
    protected function getNotificationSyncService()
    {
        return $this->services['notification_sync'] = new \Webbook\NotificationBundle\Listener\NotificationSync($this);
    }

    /**
     * Gets the 'parameters.lib.twig_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\LibBundle\Extension\Parameters A Core\LibBundle\Extension\Parameters instance
     */
    protected function getParameters_Lib_TwigExtensionService()
    {
        return $this->services['parameters.lib.twig_extension'] = new \Core\LibBundle\Extension\Parameters($this);
    }

    /**
     * Gets the 'price_float_widget' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\LibBundle\Form\Type\PriceFloat A Core\LibBundle\Form\Type\PriceFloat instance
     */
    protected function getPriceFloatWidgetService()
    {
        return $this->services['price_float_widget'] = new \Core\LibBundle\Form\Type\PriceFloat();
    }

    /**
     * Gets the 'price_integer_widget' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\LibBundle\Form\Type\PriceInteger A Core\LibBundle\Form\Type\PriceInteger instance
     */
    protected function getPriceIntegerWidgetService()
    {
        return $this->services['price_integer_widget'] = new \Core\LibBundle\Form\Type\PriceInteger();
    }

    /**
     * Gets the 'price_string_widget' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\LibBundle\Form\Type\PriceString A Core\LibBundle\Form\Type\PriceString instance
     */
    protected function getPriceStringWidgetService()
    {
        return $this->services['price_string_widget'] = new \Core\LibBundle\Form\Type\PriceString();
    }
    ...
    /**
     * Gets the 'role.route.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Webbook\MessagingBundle\Services\routeRole A Webbook\MessagingBundle\Services\routeRole instance
     */
    protected function getRole_Route_ServiceService()
    {
        return $this->services['role.route.service'] = new \Webbook\MessagingBundle\Services\routeRole($this->get('security.authorization_checker'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_ApiService()
    {
        ...
        return $this->services['security.firewall.map.context.api'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => ${($_ = isset($this->services['security.channel_listener']) ? $this->services['security.channel_listener'] : $this->getSecurity_ChannelListenerService()) && false ?: '_'}, 1 => new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $a, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($a, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/logout')), 2 => new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener($this->get('security.authentication.guard_handler'), $c, 'api', array(0 => $this->get('lexik_jwt_authentication.jwt_token_authenticator')), $d), 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $c, ${($_ = isset($this->services['security.authentication.session_strategy']) ? $this->services['security.authentication.session_strategy'] : $this->getSecurity_Authentication_SessionStrategyService()) && false ?: '_'}, $a, 'api', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($this->get('lexik_jwt_authentication.handler.authentication_success'), array('always_use_default_target_path' => false, 'default_target_path' => '/', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false), 'api'), new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationFailureHandler($this->get('lexik_jwt_authentication.handler.authentication_failure'), array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path')), array('check_path' => 'api_fos_user_security_check', 'require_previous_session' => false, 'use_forward' => false, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $d, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE), NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5955125769f498.34362419', $d, $c), 5 => ${($_ = isset($this->services['security.access_listener']) ? $this->services['security.access_listener'] : $this->getSecurity_AccessListenerService()) && false ?: '_'}), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, ${($_ = isset($this->services['security.authentication.trust_resolver']) ? $this->services['security.authentication.trust_resolver'] : $this->getSecurity_Authentication_TrustResolverService()) && false ?: '_'}, $a, 'api', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($this->get('http_kernel'), $a, '/login', false), NULL, NULL, $d, true), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('api', 'security.user_checker', 'security.request_matcher.83414b4f59ab53f8865b08d5074e037efbb06e57ccba58ede5e1ed417a9ddcd1b645c11b', true, true, 'fos_user.user_provider.username', NULL, 'security.authentication.form_entry_point.api', NULL, NULL, array(0 => 'logout', 1 => 'guard', 2 => 'form_login', 3 => 'anonymous')));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => ${($_ = isset($this->services['security.channel_listener']) ? $this->services['security.channel_listener'] : $this->getSecurity_ChannelListenerService()) && false ?: '_'}, 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => ${($_ = isset($this->services['fos_user.user_provider.username']) ? $this->services['fos_user.user_provider.username'] : $this->getFosUser_UserProvider_UsernameService()) && false ?: '_'}), 'main', $b, $c, $d), 2 => $h, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $g, ${($_ = isset($this->services['security.authentication.session_strategy']) ? $this->services['security.authentication.session_strategy'] : $this->getSecurity_Authentication_SessionStrategyService()) && false ?: '_'}, $e, 'main', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($this->get('login_success_handler'), array('login_path' => 'fos_user_security_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false), 'main'), $i, array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5955125769f498.34362419', $b, $g), 5 => ${($_ = isset($this->services['security.access_listener']) ? $this->services['security.access_listener'] : $this->getSecurity_AccessListenerService()) && false ?: '_'}), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $d, $e, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, 'fos_user_security_login', false), NULL, NULL, $b, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', 'security.request_matcher.a64d671f18e5575531d76c1d1154fdc4476cb8a79c02ed7a3469178c6d7b96b5ed4e60db', true, false, 'fos_user.user_provider.username', 'main', 'security.authentication.form_entry_point.main', NULL, NULL, array(0 => 'logout', 1 => 'form_login', 2 => 'anonymous')));
    }
    ...
    /**
     * Gets the 'select_checkbox_cueillette_widget' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\LibBundle\Form\Type\SelectCheckboxCueillette A Core\LibBundle\Form\Type\SelectCheckboxCueillette instance
     */
    protected function getSelectCheckboxCueilletteWidgetService()
    {
        return $this->services['select_checkbox_cueillette_widget'] = new \Core\LibBundle\Form\Type\SelectCheckboxCueillette();
    }

    /**
     * Gets the 'select_checkbox_cueillettes_widget' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\LibBundle\Form\Type\SelectCheckboxCueillettes A Core\LibBundle\Form\Type\SelectCheckboxCueillettes instance
     */
    protected function getSelectCheckboxCueillettesWidgetService()
    {
        return $this->services['select_checkbox_cueillettes_widget'] = new \Core\LibBundle\Form\Type\SelectCheckboxCueillettes($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'select_checkbox_entity_widget' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\LibBundle\Form\Type\SelectCheckboxEntity A Core\LibBundle\Form\Type\SelectCheckboxEntity instance
     */
    protected function getSelectCheckboxEntityWidgetService()
    {
        return $this->services['select_checkbox_entity_widget'] = new \Core\LibBundle\Form\Type\SelectCheckboxEntity();
    }

    /**
     * Gets the 'select_checkbox_products_widget' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\LibBundle\Form\Type\SelectCheckboxProducts A Core\LibBundle\Form\Type\SelectCheckboxProducts instance
     */
    protected function getSelectCheckboxProductsWidgetService()
    {
        return $this->services['select_checkbox_products_widget'] = new \Core\LibBundle\Form\Type\SelectCheckboxProducts($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'select_checkbox_widget' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\LibBundle\Form\Type\SelectCheckbox A Core\LibBundle\Form\Type\SelectCheckbox instance
     */
    protected function getSelectCheckboxWidgetService()
    {
        return $this->services['select_checkbox_widget'] = new \Core\LibBundle\Form\Type\SelectCheckbox();
    }

    /**
     * Gets the 'selectize_choice_widget' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\LibBundle\Form\Type\SelectizeChoiceType A Core\LibBundle\Form\Type\SelectizeChoiceType instance
     */
    protected function getSelectizeChoiceWidgetService()
    {
        return $this->services['selectize_choice_widget'] = new \Core\LibBundle\Form\Type\SelectizeChoiceType();
    }

    /**
     * Gets the 'selectize_widget' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\LibBundle\Form\Type\SelectizeType A Core\LibBundle\Form\Type\SelectizeType instance
     */
    protected function getSelectizeWidgetService()
    {
        return $this->services['selectize_widget'] = new \Core\LibBundle\Form\Type\SelectizeType();
    }
    ...
    {
        return $this->services['session.storage.native'] = new \Symfony\Component\HttpFoundation\Session\Storage\NativeSessionStorage(array('cookie_lifetime' => 3600000, 'cookie_httponly' => true, 'gc_probability' => 1), NULL, ${($_ = isset($this->services['session.storage.metadata_bag']) ? $this->services['session.storage.metadata_bag'] : $this->getSession_Storage_MetadataBagService()) && false ?: '_'});
    }
    ...
    /**
     * Gets the 'syn_notification.topic_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Webbook\NotificationBundle\Topic\NotificationTopic A Webbook\NotificationBundle\Topic\NotificationTopic instance
     */
    protected function getSynNotification_TopicServiceService()
    {
        return $this->services['syn_notification.topic_service'] = new \Webbook\NotificationBundle\Topic\NotificationTopic($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    /**
     * Gets the 'tooltip_text_widget' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\LibBundle\Form\Type\TooltipText A Core\LibBundle\Form\Type\TooltipText instance
     */
    protected function getTooltipTextWidgetService()
    {
        return $this->services['tooltip_text_widget'] = new \Core\LibBundle\Form\Type\TooltipText();
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => true, 'resource_files' => array('af' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.af.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.af.yml')), 'ar' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ar.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ar.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ar.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ar.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ar.yml'), 5 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.ar.yml')), 'az' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.az.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.az.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.az.xlf')), 'bg' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.bg.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.bg.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.bg.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.bg.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.bg.yml')), 'ca' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ca.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ca.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ca.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ca.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ca.yml')), 'cs' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.cs.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.cs.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.cs.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.cs.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.cs.yml'), 5 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.cs.yml')), 'cy' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.cy.xlf')), 'da' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.da.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.da.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.da.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.da.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.da.yml')), 'de' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.de.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.de.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.de.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.de.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.de.yml'), 5 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.de.yml'), 6 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.de.xliff')), 'el' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.el.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.el.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.el.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.el.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.el.yml')), 'en' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.en.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.en.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.en.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.en.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.en.yml'), 5 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.en.yml'), 6 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.en.xliff')), 'es' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.es.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.es.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.es.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.es.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.es.yml'), 5 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.es.yml'), 6 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.es.xliff')), 'et' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.et.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.et.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.et.yml')), 'eu' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.eu.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.eu.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.eu.yml'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.eu.yml')), 'fa' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fa.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fa.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.fa.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.fa.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.fa.yml')), 'fi' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fi.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fi.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.fi.yml'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.fi.yml')), 'fr' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fr.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fr.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.fr.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.fr.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.fr.yml'), 5 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.fr.yml'), 6 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.fr.xliff')), 'gl' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.gl.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.gl.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.gl.xlf')), 'he' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.he.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.he.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.he.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.he.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.he.yml')), 'hr' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hr.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hr.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.hr.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.hr.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.hr.yml')), 'hu' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hu.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hu.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.hu.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.hu.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.hu.yml'), 5 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.hu.yml')), 'hy' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hy.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hy.xlf')), 'id' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.id.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.id.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.id.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.id.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.id.yml')), 'it' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.it.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.it.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.it.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.it.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.it.yml'), 5 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.it.yml')), 'ja' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ja.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ja.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ja.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ja.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ja.yml')), 'lb' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.lb.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lb.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.lb.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.lb.yml')), 'lt' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.lt.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lt.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.lt.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.lt.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.lt.yml')), 'lv' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.lv.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lv.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.lv.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.lv.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.lv.yml')), 'mn' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.mn.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.mn.xlf')), 'nl' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.nl.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.nl.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.nl.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.nl.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.nl.yml')), 'nn' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.nn.xlf')), 'no' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.no.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.no.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.no.xlf')), 'pl' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pl.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pl.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.pl.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.pl.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.pl.yml'), 5 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.pl.yml'), 6 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.pl.xliff')), 'pt' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pt.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pt.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.pt.yml'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.pt.yml'), 4 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.pt.yml')), 'pt_BR' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pt_BR.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pt_BR.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.pt_BR.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.pt_BR.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.pt_BR.yml')), 'ro' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ro.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ro.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ro.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ro.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ro.yml'), 5 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.ro.xliff')), 'ru' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ru.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ru.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ru.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ru.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ru.yml'), 5 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.ru.yml'), 6 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.ru.xliff')), 'sk' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sk.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sk.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sk.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.sk.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.sk.yml')), 'sl' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sl.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sl.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sl.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.sl.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.sl.yml'), 5 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.sl.yml')), 'sq' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sq.xlf')), 'sr_Cyrl' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sr_Cyrl.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sr_Cyrl.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sr_Cyrl.xlf')), 'sr_Latn' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sr_Latn.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sr_Latn.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sr_Latn.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.sr_Latn.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.sr_Latn.yml')), 'sv' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sv.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sv.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sv.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.sv.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.sv.yml')), 'th' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.th.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.th.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.th.yml'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.th.yml')), 'tr' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.tr.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.tr.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.tr.yml'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.tr.yml'), 4 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.tr.yml')), 'uk' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.uk.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.uk.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.uk.yml'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.uk.yml'), 4 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.uk.yml')), 'vi' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.vi.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.vi.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.vi.yml'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.vi.yml')), 'zh_CN' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.zh_CN.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.zh_CN.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.zh_CN.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.zh_CN.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.zh_CN.yml')), 'zh_TW' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.zh_TW.xlf')), 'pt_PT' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.pt_PT.xlf')), 'ua' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ua.xlf')), 'eo' => array(0 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.eo.yml'), 1 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.eo.yml')), 'ky' => array(0 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ky.yml'), 1 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ky.yml'), 2 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.ky.xliff')), 'nb' => array(0 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.nb.yml'), 1 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.nb.yml')))), array());
    ...
    /**
     * Gets the 'tree.twig.extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Fuz\Jordan\Twig\Extension\TreeExtension A Fuz\Jordan\Twig\Extension\TreeExtension instance
     */
    protected function getTree_Twig_ExtensionService()
    {
        return $this->services['tree.twig.extension'] = new \Fuz\Jordan\Twig\Extension\TreeExtension();
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'form/form.book_block.html.twig'), 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'name', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));

        $instance->addExtension($this->get('tree.twig.extension'));
        $instance->addExtension($this->get('twig.extension.sortbyfield'));
        $instance->addExtension(new \Webbook\MainBundle\Twig\Extension\BlockOptions($this));
        ...
        $instance->addExtension($this->get('parameters.lib.twig_extension'));
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension(${($_ = isset($this->services['assetic.asset_factory']) ? $this->services['assetic.asset_factory'] : $this->getAssetic_AssetFactoryService()) && false ?: '_'}, $this->get('templating.name_parser'), true, array(), array(0 => 'GosWebSocketBundle', 1 => 'MainBundle', 2 => 'FrontOfficeBundle', 3 => 'MessagingBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
        $instance->addExtension(new \Webbook\NotificationBundle\Extension\CountNotificationExtension($this));
        ...
        $instance->addExtension(new \Webbook\MessagingBundle\Twig\Extension\MessageSupport($this));
        ...
        $instance->addGlobal('gos_web_socket_server_host', 'http://webbook.marzouk-med.loc');
        $instance->addGlobal('gos_web_socket_server_port', 8080);
        $instance->addGlobal('siteUrl', 'http://webbook.marzouk-med.loc');
    ...
    /**
     * Gets the 'twig.extension.sortbyfield' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        return $this->services['twig.form.renderer'] = new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'form/form.book_block.html.twig'), $this->get('twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Core\\UserBundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[2].'/Resources/FOSUserBundle/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Core\\LibBundle/Resources/views'), 'Lib');
        $instance->addPath(($this->targetDirs[3].'\\src\\Core\\UserBundle/Resources/views'), 'User');
        $instance->addPath(($this->targetDirs[3].'\\src\\Webbook\\MainBundle/Resources/views'), 'Main');
        $instance->addPath(($this->targetDirs[3].'\\src\\Webbook\\NotificationBundle/Resources/views'), 'Notification');
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Webbook\\FrontOfficeBundle/Resources/views'), 'FrontOffice');
        $instance->addPath(($this->targetDirs[3].'\\src\\Webbook\\MessagingBundle/Resources/views'), 'Messaging');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('5f246d17b0afa2c76634adb94fa77bbfb87c16db');
    }
    ...
    /**
     * Gets the 'weeks_widget' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\LibBundle\Form\Type\WeeksType A Core\LibBundle\Form\Type\WeeksType instance
     */
    protected function getWeeksWidgetService()
    {
        return $this->services['weeks_widget'] = new \Core\LibBundle\Form\Type\WeeksType();
    }

    /**
     * Gets the 'years_selector_widget' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\LibBundle\Form\Type\YearsSelector A Core\LibBundle\Form\Type\YearsSelector instance
     */
    protected function getYearsSelectorWidgetService()
    {
        return $this->services['years_selector_widget'] = new \Core\LibBundle\Form\Type\YearsSelector();
    }

    /**
     * Gets the 'years_widget' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\LibBundle\Form\Type\YearType A Core\LibBundle\Form\Type\YearType instance
     */
    protected function getYearsWidgetService()
    {
        return $this->services['years_widget'] = new \Core\LibBundle\Form\Type\YearType();
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('loFBn+2ouA', 0, 'ZnoRaJmMC17ZiXp-PVQxIK', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('N8TK1M0gwx', 0, 'ZnoRaJmMC17ZiXp-PVQxIK', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/author'), array(0 => 'ROLE_AUTHOR'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/validator'), array(0 => 'ROLE_VALIDATOR'), NULL);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(array(0 => $this->get('lexik_jwt_authentication.jwt_token_authenticator')), $a, 'api', $b), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'api', $c, true), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5955125769f498.34362419'), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'main', $c, true), 4 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5955125769f498.34362419')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_USER' => array(0 => 'ROLE_USER'), 'ROLE_CLIENT' => array(0 => 'ROLE_CLIENT'), 'ROLE_AUTHOR' => array(0 => 'ROLE_AUTHOR'), 'ROLE_VALIDATOR' => array(0 => 'ROLE_VALIDATOR'), 'ROLE_ADMINISTRATOR' => array(0 => 'ROLE_ADMINISTRATOR'), 'ROLE_SUPER_ADMINISTRATOR' => array(0 => 'ROLE_ADMINISTRATOR', 1 => 'ROLE_SUPER_ADMINISTRATOR')));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'LibBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Core\\LibBundle'),
                    'namespace' => 'Core\\LibBundle',
                ),
                'AsseticBundle' => array(
                    'parent' => NULL,
                ...
                'UserBundle' => array(
                    ...
                    'path' => ($this->targetDirs[3].'\\src\\Core\\UserBundle'),
                    'namespace' => 'Core\\UserBundle',
                ),
                'MainBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Webbook\\MainBundle'),
                    'namespace' => 'Webbook\\MainBundle',
                ),
                'NotificationBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Webbook\\NotificationBundle'),
                    'namespace' => 'Webbook\\NotificationBundle',
                ),
                ...
                'FrontOfficeBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Webbook\\FrontOfficeBundle'),
                ...
                'MessagingBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Webbook\\MessagingBundle'),
                    'namespace' => 'Webbook\\MessagingBundle',
                ),
                ...
                'KnpSnappyBundle' => array(
                    'parent' => NULL,
                    'path' => 'D:/PFE/webbook/vendor/knplabs/knp-snappy-bundle',
            ...
            case 'upload_dir': $value = ($this->targetDirs[2].'/../web/uploads'); break;
            case 'jwt_private_key_path': $value = ($this->targetDirs[2].'/../var/jwt/private.pem'); break;
            case 'jwt_public_key_path': $value = ($this->targetDirs[2].'/../var/jwt/public.pem'); break;
            ...
            case 'vich_uploader.mappings': $value = array(
                'media_file' => array(
                    ...
                    'namer' => array(
                        'service' => 'media_namer.file_namer.media_file',
                        'options' => array(
            ...
            case 'lexik_jwt_authentication.private_key_path': $value = ($this->targetDirs[2].'/../var/jwt/private.pem'); break;
            case 'lexik_jwt_authentication.public_key_path': $value = ($this->targetDirs[2].'/../var/jwt/public.pem'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'LibBundle' => 'Core\\LibBundle\\LibBundle',
                'AsseticBundle' => 'Symfony\\Bundle\\AsseticBundle\\AsseticBundle',
                'UserBundle' => 'Core\\UserBundle\\UserBundle',
                'MainBundle' => 'Webbook\\MainBundle\\MainBundle',
                'NotificationBundle' => 'Webbook\\NotificationBundle\\NotificationBundle',
                ...
                'FrontOfficeBundle' => 'Webbook\\FrontOfficeBundle\\FrontOfficeBundle',
                'FOSRestBundle' => 'FOS\\RestBundle\\FOSRestBundle',
                'LexikJWTAuthenticationBundle' => 'Lexik\\Bundle\\JWTAuthenticationBundle\\LexikJWTAuthenticationBundle',
                'NelmioCorsBundle' => 'Nelmio\\CorsBundle\\NelmioCorsBundle',
                'MessagingBundle' => 'Webbook\\MessagingBundle\\MessagingBundle',
            ...
            'secret' => '5f246d17b0afa2c76634adb94fa77bbfb87c16db',
            'jwt_key_pass_phrase' => 'astalavista',
            'jwt_token_ttl' => 3600,
            'site_url' => 'http://webbook.marzouk-med.loc',
            'locale' => 'fr',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '5f246d17b0afa2c76634adb94fa77bbfb87c16db',
            ...
            'security.role_hierarchy.roles' => array(
                ...
                'ROLE_VALIDATOR' => array(
                    0 => 'ROLE_VALIDATOR',
                ),
                'ROLE_ADMINISTRATOR' => array(
                    0 => 'ROLE_ADMINISTRATOR',
                ),
                'ROLE_SUPER_ADMINISTRATOR' => array(
                    0 => 'ROLE_ADMINISTRATOR',
                    1 => 'ROLE_SUPER_ADMINISTRATOR',
                ),
            ),
            ...
            'twig.form.resources' => array(
                ...
                1 => 'form/form.book_block.html.twig',
            ),
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'test@gamil.com' => 'test@gamil.com',
            ),
            'fos_user.registration.confirmation.enabled' => false,
            'fos_user.registration.form.type' => 'Core\\UserBundle\\Form\\RegistrationFormType',
            ...
            'web_socket_server.host' => 'http://webbook.marzouk-med.loc',
            ...
            'lexik_jwt_authentication.pass_phrase' => 'astalavista',
            ...
            'knp_paginator.template.pagination' => 'KnpPaginatorBundle/Pagination/custom_pagination.html.twig',
