	...
	$.widget("mjs.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
		...
		_mouseDrag: function(event) {
			...
			if (parentItem != null &&
                ...
                $('.placeholder').html('<div class="arrow-left">  </div> <div class="indicator"> </div> <div class="angle-left"></div>');
				...
				$('.placeholder').html('<div class="angle-right"> </div> <div class="indicator"> </div> <div class="arrow-right"> </div>');
